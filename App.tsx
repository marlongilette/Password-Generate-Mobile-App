...
const PasswordSchema = Yup.object().shape({
  ...
  .required('The password lenth is required')
})
...
const styles = StyleSheet.create({
  appContainer: {flex: 1},
  formContainer: {margin: 8, padding: 8},
  title: {fontSize: 32, fontWeight: '600', marginBottom: 15},
  subTitle: {fontSize: 26, fontWeight: '600', marginBottom: 2},
  description: {color: '#758283', marginBottom: 2},
  heading: {fontSize: 15},
  inputWrapper: {
    marginBottom: 15,
    alignItems: 'center',
